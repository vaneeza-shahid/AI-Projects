...
def generate_stream(message_history):
    ...
    messages.insert(0, {
        ...
        and the effectiveness of the recipe using quantitative values. Also, list the relevant recipes along with a brief description of each. Do not respond to off-topic inquiries"""})
